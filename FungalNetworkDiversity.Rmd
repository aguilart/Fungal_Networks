...
```{r}
#1. C34 C34(1)_t11 Mortierella elongata
par(mar=c(0,0,0,0))
...
#ecol<-cscale(E(colonies_ntwk[[5]])$width,palette = seq_gradient_pal(low = "yellow",high = "red"))
...
#4. DF19 "Mortierella alpina DF19(1)_t11
...
#5. DF25 Mortierella elongata2 DF25(6)_t11
ecol<-cscale(E(colonies_ntwk[[11]])$width,palette = div_gradient_pal(low = "#FDE725FF",mid = "#1F968BFF",high = "#440154FF"))
...
ecol[E(colonies_ntwk[[16]])[type=="Inoculum"]]<-"bisque2"
plot(colonies_ntwk[[16]],
     edge.arrow.size=1,edge.curved=0,edge.width=2,
     vertex.label=NA,vertex.shape="none",
     edge.color=ecol,
...
#7. DF9 Alternaria sp "DF9(5)_t25_c
...
#9. M  Mortierella alpina2 M(5)_t13_c
ecol<-cscale(E(colonies_ntwk[[22]])$width,palette = div_gradient_pal(low = "#FDE725FF",mid = "#1F968BFF",high = "#440154FF"))
...
#12.Rb Resinicium bicolor, "Rb_ctrl1_d8_1
ecol<-cscale(E(colonies_ntwk[[30]])$width,palette = div_gradient_pal(low = "#FDE725FF",mid = "#1F968BFF",high = "#440154FF"))
ecol[E(colonies_ntwk[[30]])[type=="Inoculum"]]<-"bisque2"
plot(colonies_ntwk[[30]],
     edge.arrow.size=1,edge.curved=0,edge.width=2,
     vertex.label=NA,vertex.shape="none",
     edge.color=ecol,
     edge.size=150,vertex.size=0,layout=spatial.data[[30]]*1,main="Resinicium bicolor")
