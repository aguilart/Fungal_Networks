...
#This is not necessary because the data has been already scaled in Mark´s dataset. Actually only my dataset needs to be scaled
...
Edge_Traits$Length_scaled[-grep("Pi|Pv|Rb",Edge_Traits$name)]<-Edge_Traits$Length[-grep("Pi|Pv|Rb",Edge_Traits$name)]*0.8


Edge_Traits$Width_scaled<-Edge_Traits$Width
# Edge_Traits$Width_scaled[grep("Pi_ctrl1_d8_1",Edge_Traits$name)]<-Edge_Traits$Width[grep("Pi_ctrl1_d8_1",Edge_Traits$name)]*155
# Edge_Traits$Width_scaled[grep("Pi_ctrl1_d8_2",Edge_Traits$name)]<-Edge_Traits$Width[grep("Pi_ctrl1_d8_2",Edge_Traits$name)]*152
# Edge_Traits$Width_scaled[grep("Pi_ctrl1_d8_3",Edge_Traits$name)]<-Edge_Traits$Width[grep("Pi_ctrl1_d8_3",Edge_Traits$name)]*146
# Edge_Traits$Width_scaled[grep("Pv_ctrl1_d8_1",Edge_Traits$name)]<-Edge_Traits$Width[grep("Pv_ctrl1_d8_1",Edge_Traits$name)]*80
# Edge_Traits$Width_scaled[grep("Pv_ctrl1_d8_2",Edge_Traits$name)]<-Edge_Traits$Width[grep("Pv_ctrl1_d8_2",Edge_Traits$name)]*84
# Edge_Traits$Width_scaled[grep("Pv_ctrl1_d8_3",Edge_Traits$name)]<-Edge_Traits$Width[grep("Pv_ctrl1_d8_3",Edge_Traits$name)]*86
# Edge_Traits$Width_scaled[grep("Rb_ctrl1_d8_1",Edge_Traits$name)]<-Edge_Traits$Width[grep("Rb_ctrl1_d8_1",Edge_Traits$name)]*88
# Edge_Traits$Width_scaled[grep("Rb_ctrl1_d8_2",Edge_Traits$name)]<-Edge_Traits$Width[grep("Rb_ctrl1_d8_2",Edge_Traits$name)]*91
# Edge_Traits$Width_scaled[grep("Rb_ctrl1_d8_3",Edge_Traits$name)]<-Edge_Traits$Width[grep("Rb_ctrl1_d8_3",Edge_Traits$name)]*89

Edge_Traits$Width_scaled[-grep("Pi|Pv|Rb",Edge_Traits$name)]<-Edge_Traits$Width[-grep("Pi|Pv|Rb",Edge_Traits$name)]*0.8
...
To_plot<-bind_rows(
Edge_Traits%>%
      filter(name=="C34(1)_t11"|name=="DF56(6)_t09"|name=="C41(1)_t25_c"|name=="Rb_ctrl1_d8_1")%>% filter(EndNodes_1_Degree==1|EndNodes_2_Degree==1)%>% select(c("name","Species","Width_scaled","phylum")) %>% rename(variable=Width_scaled) %>% 
  mutate(variable_name="width_tip"),

Edge_Traits%>%
      filter(name=="C34(1)_t11"|name=="DF56(6)_t09"|name=="C41(1)_t25_c"|name=="Rb_ctrl1_d8_1")%>% filter(EndNodes_1_Degree==3|EndNodes_2_Degree==3)%>% select(c("name","Species","Width_scaled","phylum")) %>% rename(variable=Width_scaled) %>% 
  mutate(variable_name="width_main"),

Edge_Traits%>%
      filter(name=="C34(1)_t11"|name=="DF56(6)_t09"|name=="C41(1)_t25_c"|name=="Rb_ctrl1_d8_1")%>% select(c("name","Species","Length_scaled","phylum"))%>% rename(variable=Length_scaled) %>% 
...
all_data_scaled$easy_code[all_data_scaled$Species=="Phanerochaete velutina"]<-"Phan.v"
...
#All data
Model_network_traits_sps_scaled<-rda(all_data_scaled[,c("Hyphal_length",
                                                     "Hyphal_number",
                                                     "Hyphal_tip_width",
                                                     "Hyphal_main_width",
                                                     "Hyphal_angle",                                                                              "Mycelial_area",
                                                     ...
                                                     "random_robustness",
                                                     "spatial_robustness")]~Species + Condition(phylum),scale = TRUE,data = all_data_scaled)
...
Basidios1%>% 
  ...
  aes(x=RDA1,y=RDA2) +
  #geom_point(size=2)+
    geom_text(aes(label=easy_code,fontface="bold.italic"),size=5,color="#0C2C84") +
    labs(y="RDA2",x="RDA1")+
  
  geom_text(size=5,aes(x=RDA1_species,y=RDA2_species,label=traits,fontface="bold"),
...
Ascos_zygos1%>% 
  ...
  aes(x=RDA1,y=RDA2) +
  #geom_point(size=2)+
    geom_text(aes(color=phylum,label=Species),size=5) +
    labs(y="RDA2",x="RDA1")+
  ...
  ggtitle(label = "Taxonomy corrected")+
  scale_color_manual(values=c("yellowgreen","#7FCDBB"))+
...
all_data_scaled1%>% 
  ...
  ggtitle(label = "Taxonomy corrected")+
  scale_color_manual(values=c("#1D91C0","#0C2C84","#7FCDBB"))+
