...
#On 19 May, Mark suggested not to include hypholoma anymore
hfb<-grep("hf",Basidios$name_col,ignore.case = T)

Model_Basidios<-rda(Basidios[-hfb,c("Hyphal_length","Hyphal_number","Hyphal_tip_width",
                                      "Hyphal_main_width","Hyphal_angle","Mycelial_area",
                                      "Hyphal_density","alpha_coeff","Root_eff","Reff_tip",
                                      "Mycelia_Vol_MST","Geff_MST","des_length_robustness",
                               "asc_width_robustness","des_width_robustness","random_robustness",
                                      "spatial_robustness")]~Species ,scale = TRUE,data = Basidios[-hfb,])
...
#On 19 May, Mark suggested not to include hypholoma anymore
hf<-grep("hf",all_data_scaled_c$name_col,ignore.case = T)

Model_network_traits_sps_scaled<-
  rda(all_data_scaled_c[-hf,c("Hyphal_angle","Hyphal_density","alpha_coeff","Root_eff_a_scaled",
      ...
      scale = TRUE,data = all_data_scaled_c[-hf,])
...
Basidios1<-cbind(Basidios[-hfb,],temporal);rm(temporal)
...
Basidios1%>% 
  ...
  geom_text(size=3,aes(x=RDA1_species,y=RDA2_species,
...
all_data_scaled1<-cbind(all_data_scaled[-hf,],temporal);rm(temporal)
...
all_data_scaled_c[-hf,c("Hyphal_number","Hyphal_angle","Hyphal_density","alpha_coeff",
...
temporal1<-cbind(temporal1,all_data_scaled_c[-hf,c("name_col")])
