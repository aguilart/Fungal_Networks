...
data_location_B<-"results_20210414/"#This is new basidiomycete data from Mark sent on 14 April 2020

#random datasets for testing the behavior of particular parameters
data_location<-"D:/Carlos_miscelaneous/processed data/results/"
```
...
summary_Traits_table_AZB$name_col<-c(temp,temp_b)
...
The previous chucnk was executed once, only if necessary (new data input) I run it again, otherwise I just import the output of the chunck that I saved it (I did this because it takes a lot of time to calculate global efficiney)
