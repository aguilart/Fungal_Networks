...
For the global efficiency of the Basidiomycetes. A bit time consuming so I save the results: I did this because the original Freyas did not have global efficiency. Later in Mark´s batches, he added this variables so it is not necessary to do this anymore.
...
all_data_scaled$Mycelia_length_scaled<-all_data[c(1:35),]$Mycelia_length/all_data[c(36:70),]$Mycelia_length
...
all_data_scaled$Root_eff_scaled<-all_data[c(1:35),]$Root_eff/all_data[c(36:70),]$Root_eff
all_data_scaled$Reff_tip_scaled<-all_data[c(1:35),]$Reff_tip/all_data[c(36:70),]$Reff_tip
all_data_scaled$Geff_scaled<-all_data[c(1:35),]$Geff/all_data[c(36:70),]$Geff
