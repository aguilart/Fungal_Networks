...
Lenght matches quite well for my data. for the basidios it´s bit off with pv

Is resinicium ok? It differs widely in width and in efficiency estimates

Problem with one single colony for area in the new data C34(3)_t23

Accessibility did not match for 1 species (old data is really high) DF19(2)

what is the name of Hf

Data matches ok, much better the efficiencies, for some reason root tip efficiency does not
