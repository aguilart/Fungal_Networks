...
The edges maximum betweenness for each colony is located always closer to the center of the colony
```{r}
...
sapply(
  split(Edge_Traits,Edge_Traits$name),function(x){
    summary(x$Betweenness[x$Distance<=1.5*min(x$Distance)])
  }
...
b) They represent they represent the 6% to 14% of all edges
```{r}
with(
  Edge_Traits[which(Edge_Traits$Betweenness==0),],
